const messages = (getText, getPlural) => (key) =>
  ({
    ...
    registeredList: getText('The following athletes are now registered:') /* Label for a list of registered riders */,
    ...
    riderNumber: getText('Athlete Number') /* Indicates a registered rider's number */,
