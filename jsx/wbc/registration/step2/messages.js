const messages = (getText, getPlural) => (key) =>
  ({
    ...
    registeredRidersAndPrice: getText('Registered athlete(s) and price') /* Name of a section to enter the information for registered riders */,

    youCanRegisterOthers: getText('You can register yourself and/or other athletes.') /* Paragraph indicating that it's possible to register more than one rider at a time. */,

    registeringFor: getText('Registering for') /* Label for a section containing a list of competitions a rider can take part in */,

    addRider: getText('Add Athlete') /* Label for a button to add a registered rider */,
    removeRider: getText('Remove Athlete') /* Label for a button to remove a registered rider */,

    riderCount: (riderCount) => getPlural('%d athlete', '%d athletes', riderCount),
    ...
    chooseCategory: getText('Choose the athlete\'s category') /* Label for a field listing categories */,
    ...
    ridersFirstName: getText('Enter the athlete\'s first name') /* Help text to tell the user whose first name should be entered */,
    ridersLastName: getText('Enter the athlete\'s last name') /* Help text to tell the user whose last name should be entered */,

    riderNumber: getText('Athlete number') /* Label for a field to choose a rider's flag number */,
    ...
    rider: getText('Athlete') /* Indicates the rider's number in the list */,
    ...
    conflict: getText('Cannot participate if not riding') /* Displayed when an athlete checked 'not riding' but chose a competition type anyway */,
