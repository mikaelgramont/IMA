...
function renderItem($data) {
    ...
    <li class="stream-photo{$videoClass}">
        <a class="stream-photo-image" target="_blank" href="{$href}">
            <img data-src="{$data->src}" data-id="{$data->id}">
        </a>
        <a class="stream-photo-metadata" target="_blank" href="{$href}">
            {$metadata}
        </a>
    </li>
...
<style>
    ...
    .stream-photo.video .stream-photo-image::after {
        content: " ";
        display: block;
...
<section>
    <h1 class="display-font">World Boardercross Championship 2019 (September 6th-7th) - live coverage</h1>
    <p>We'll be adding updates as the event takes place, so come back often!</p>

    <p>
        For schedule information, check out <a href="https://wbc.mountainboardworld.org/competition" target="_blank">the timeline on the official event site</a>.
    </p>
...
?>
        ...
        <div class="ig-stream">
            <h2 class="display-font">The WBC on Instagram</h2>
<?php
$i = 0;
