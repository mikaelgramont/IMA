...
define('SITE_NAME', 'World Boardercross Championship - International Mountainboard Association');
define('KEYWORDS', 'IMA, international mountainboard association, mountainboard, boardercross, dirtboard, allterrainboard, ATBA');
define('ANALYTICS_ID', 'UA-110037113-3');


/******************************************************************************
 * SOCIAL MEDIA CONSTANTS
 *****************************************************************************/
define('FB_EVENT_URL', 'https://www.facebook.com/events/1990092361294949/');
 ...
 * OPEN GRAPH
 *****************************************************************************/
define('OG_TITLE', 'World Boardercross Championship - International Mountainboard Association');
define('OG_DESCRIPTION', 'The official World Boardercross Championship registration and information.');
define('OG_URL', 'https://wbc.mountainboardworld.org/');
define('OG_SITE_NAME', 'World Boardercross Championship - International Mountainboard Association');
define('OG_IMAGE', 'https://wbc.mountainboardworld.org/images/poster.jpg');
...
/******************************************************************************
 * WBC REGISTRATION CONSTANTS
 *****************************************************************************/
define('REGISTRATION_COST', 35);
define('REGISTRATION_DEADLINE', 'Aug 31st 2019');
define('REGISTRATIONS_LOG_FILE', '../logs/wbc-registrations.json');
